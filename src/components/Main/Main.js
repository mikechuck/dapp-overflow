					...
					<div className="column-middle col-sm-7">
						...
						<form onSubmit={(event) => {
							...
							<div className="form-group mr-sm-2">
								<textarea id="imageDescription" type="text" ref={(input) => { this.imageDescription = input }} className="form-control" placeholder="What do you want to know?" required />
							</div>
								...
								<div className="card question-card mb-4" key={key} >
									...
									<ul id="imageList" className="list-group list-group-flush">
										<li className="list-group-item container">
											<div className="image-container col-sm-3">
												<img src={`https://ipfs.infura.io/ipfs/${image.hash}`} />
											</div>
											<div className="description-container col-sm-9">
